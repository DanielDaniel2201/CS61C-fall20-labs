...
map:
    ...
    # THINK: why a0? my answer: current node value in a0 so that can be used as argument on the function call
    ### YOUR CODE HERE ###
    lw a0, 0(s0)
    ...
    # Where can you assume the returned value is? my answer: in a0 as square function did
    ### YOUR CODE HERE ###
    sw a0, 0(s0)
    ...
    # THINK: why a1? What about a0? my answer: to correspond to the a resgisters set in the beginning of this program, a0 is for the node address
    ### YOUR CODE HERE ###
    mv a1, s1
